...
$(function($){
	...
	geoGet(false);
        ...
        swal({
            title: "位置情報を取得します",
            // text: "本サイトは周辺不動産情報を検索するため\n"
	    // 	+ "デバイスの位置情報を使用いたします。\n\n"
	    // 	+ "ご利用にあたり位置情報取得の許可をお願いいたします。\n"
	    // 	+ "※当サイトが位置情報を記録したり、\n"
	    // 	+ "外部送信することはありません。",
	    html: true,
            text: "本サイトは周辺不動産情報を検索するため<br/>デバイスの位置情報を使用いたします。<br/><br/>"
		+ "ご利用にあたり位置情報の取得許可をお願いいたします。<br/><br/>"
		+ '<span style="font-size: 75%">'
		+ "※当サイトが位置情報を収集または外部送信することはありません。<br/>"
                + "※アンテナ等の状況により取得には最大15秒かかることがあります。"
		+ '</span>',
            type: "warning",
